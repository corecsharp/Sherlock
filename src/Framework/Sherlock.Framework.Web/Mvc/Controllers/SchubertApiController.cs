...
{
    [WebApi]
    public abstract class SherlockApiController : ControllerBase, ISherlockController
    {
        ...
        WorkContext ISherlockController.WorkContext
        {
            get { return this.WorkContext; }
        }

        ILoggerFactory ISherlockController.LoggerFactory
        {
