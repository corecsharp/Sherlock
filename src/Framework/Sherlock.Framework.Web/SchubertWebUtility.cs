...
namespace Sherlock
{
    public static partial class SherlockWebUtility
    {
        /// <summary>
        /// 获取 Windows 用户文件夹。
        /// </summary>
        ...
        public static IMvcCoreBuilder AddWebApiConventions(this IMvcCoreBuilder builder)
        {
            ...
            builder.Services.TryAddEnumerable(
                ServiceDescriptor.Transient<IConfigureOptions<MvcOptions>, ApiOptionsSetup>());
