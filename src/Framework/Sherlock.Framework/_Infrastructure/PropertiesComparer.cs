...
namespace Sherlock
{
    public sealed class PropertiesComparer
    {
        ...
        {
            if(handling == Sherlock.CollectionPropertyHandling.Ingore)
            {
                return true;
            }
            ...
            switch (handling)
            {
                case Sherlock.CollectionPropertyHandling.ElementEqualCompare:
                    ...
                    return true;
                case Sherlock.CollectionPropertyHandling.ElementPropertyCompare:
                     for (int i = 0; i < array1.Length; i++)
                    {
                    ...
                    return true;
                case Sherlock.CollectionPropertyHandling.EqualCompare:
        ...
        private bool ObjectEquals(Type propertyType, object value1, object value2, RefrencePropertyHandling handling)
        {
            switch (handling)
            {
                case Sherlock.RefrencePropertyHandling.EqualCompare:
                    bool containsNull = false;
                ...
                case Sherlock.RefrencePropertyHandling.PropertyCompare:
