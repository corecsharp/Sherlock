...
namespace Sherlock.Framework.Environment.ShellBuilders
{
    ...
    {
        internal const string FrameworkFeatureName = "Sherlock.Framework";
        ...
        /// <param name="options">Sherlock 框架基础配置。</param>
        /// <param name="exporters">Shell 部件导出器。</param>
        public CompositionStrategy(IFeatureManager featureManager, ILoggerFactory loggerFactory, IOptions<SherlockOptions> options, IEnumerable<IShellBlueprintItemExporter> exporters)
        {
