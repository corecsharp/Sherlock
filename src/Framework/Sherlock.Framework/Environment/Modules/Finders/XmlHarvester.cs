...
namespace Sherlock.Framework.Environment.Modules.Finders
{
    /// <summary>
    /// 从 Xml 清单中组织模块的对象。
    /// </summary>
    public class XmlHarvester : FileContentHarvester
    {
        ...
        /// 意味着任何模块都包含至少一个 Feature，该 Feature 表示没有明确通过 <see cref="SherlockFeatureAttribute"/> 属性标记的组件。
        /// </summary>
        ...
        private void ParseModuleAttributes(ModuleDescriptor module, XElement moduleElement)
        {
            ...
            {
                throw new SherlockException($@"读取 XML 模块配置文件发生错误， module 元素必须制定 name 属性。");
            }
