...
namespace Sherlock.Framework
{
    ...
    /// </summary>
    /// <param name="options">当前 Sherlock 配置选项。</param>
    /// <param name="context">Shell 上下文。</param>
    public delegate void ShellInitializedHandler(SherlockOptions options, ShellContext context);
    /// <summary>
    /// 用于订阅 引擎启动完成事件的委托。
    /// </summary>
    /// <param name="options">当前 Sherlock 配置选项。</param>
    /// <param name="serviceProvider">应用程序级别的服务提供程序。</param>
    public delegate void EngineStartedHandler(SherlockOptions options, IServiceProvider serviceProvider);

    public delegate void DependencySetupHandler(SherlockOptions options, DependencySetupEventArgs eventArgs);
    ...
    public static class ShellEvents
    {
        ...
        internal static void NotifyDependencyRegistering(SherlockOptions options, DependencySetupEventArgs args)
        {
        ...
        internal static void NotifyShellInitialized(SherlockOptions options, ShellContext context)
        {
        ...
        internal static void NotifyEngineStarted(SherlockOptions options, IServiceProvider builder)
        {
